import { getElement, switchTodoMap } from './index';
import { projectMap, adjustHeight } from './index';
...
export class ProjectListHandler {
  ...
  constructor() {
    ...
    this._settingsTitle = getElement('#settingsTitle');

    this.bindEvents();
  }

  private bindEvents() {
    this._settingsTitle.innerText = projectMap.projectId ?? '';
